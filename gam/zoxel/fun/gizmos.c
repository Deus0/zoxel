...
void zox_dbg_ui_gizmos(ecs* world, int32_t keycode) {
    ...
    entity3 e3 = spawn_window_list(world, prefab_window, player, "Gizmos", header_font_size, list_font_size, (ClickEvent) { NULL }, can_close, 0, 0, alignment, float2_top_left, list_padding, spawned, elements, elements_count, visible_count);

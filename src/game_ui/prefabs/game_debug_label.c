...
entity spawn_prefab_game_debug_label(ecs *world, const entity prefab) {
...
entity spawn_game_debug_label(ecs *world, const entity canvas) {
    ...
    const entity zext = spawn_label_background(world, prefab_game_debug_label, parent, canvas, pixel_position, anchor, padding, "", font_size, alignment, layer, int2_half(parent_pixel_size), parent_pixel_size, debug_color_outline, debug_color_fill, 0);

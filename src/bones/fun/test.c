...
void spawn_skeleton_bones(ecs *world, entity e, float head_move_y) {
    ...
    // = Body Bone =
    const entity bone_body = spawn_bone(world, prefab_bone, e, float3_zero, float3_zero, test_bone_size_body);
    ...
    const entity bone_child = spawn_bone(world, prefab_bone, e, bone_head_position, bone_head_position, test_bone_head_size);

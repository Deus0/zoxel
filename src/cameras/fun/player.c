...
entity2 spawn_player_cameras(ecs* world, entity app, entity player, byte camera_mode, float3 camera_position, float4 camera_rotation, float4 screen_to_canvas, int2 vp_position, int2 game_vpsize, int2 ui_vpsize) {

...
entity spawn_dialogue_ui(ecs* world, entity canvas, entity character, entity target) {
    ...
    int2 size = (int2) { canvas_size.x * 0.69f, canvas_size.y * 0.17f };
    ...
    // Speech Text
    {
        ...
        entity text_ui = spawn_text(world, prefab_dialogue_text, parent, position, position_anchor, speech_font_size, alignment, padding, text, button_font_fill, button_font_outline);

...
void define_systems_chunks(ecs *world) {
    ...
    zox_system(ChunkEntitiesLodSystem,
        EcsOnUpdate,
        [in] rendering.RenderDistanceDirty,
        [in] rendering.RenderDistance,
        [in] chunks3.ChunkEntities
    );
    zox_system(ChunkFindNeighborSystem,
        EcsOnLoad,
    ...
    zox_system(Chunk3MeshTriggerSystem,
        EcsOnUpdate,
        [in] chunks3.VoxelNodeDirty,
        [out] chunks3.ChunkMeshDirty
    );
    zox_system(Chunk3NeighborsMeshTriggerSystem,
        EcsOnUpdate,
        [in] chunks3.ChunkNeighbors,
        [in] chunks3.VoxelNodeDirty,
        [out] chunks3.ChunkMeshDirty
    );
    zox_system(VoxelNodeCleanupSystem,
        zoxp_voxels_write,
        [in] chunks3.VoxelNodeDirty,
        [in] chunks3.NodeDepth,
        [out] chunks3.VoxelNode);

    zox_system(Chunk3SaveSystem,
        EcsPreStore,
    ...
    zox_system(VoxelNodeQueueClearSystem,
        zoxp_queue_clear,
        [out] VoxelNodeQueue
    );
    // main thread
    zox_system_1(ChunkDebugSystem,
        zoxp_voxels_read,

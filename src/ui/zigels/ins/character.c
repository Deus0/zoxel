entity spawn_zigel(ecs* world, entity prefab, entity parent, float2 position_anchor, int2 size, int2 tsize, byte index, byte thickness, byte othickness, color fill, color outline) {
    zox_instance(prefab);
    zox_name("zigel");

entity spawn_zigel(ecs* world, entity prefab, entity parent, byte zigel_index, ushort data_index, float2 position_anchor, int2 size, int2 texture_size, byte thickness, byte othickness, color fill, color outline) {
    zox_instance(prefab);
    zox_name("zigel");

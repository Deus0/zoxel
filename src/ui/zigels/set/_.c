...
const color default_font_outline_color = { 55, 125, 125, 255 };
const color default_font_fill_color = { 55, 185, 125, 255 };
...
const byte font_size_frame_label = 8; // 12;
// const byte font_resolution_frame_label = 16;

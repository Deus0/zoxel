...
void test_ui_pixel_positions(ecs *world) {
    ...
    int bar_width = screen_size.x / width_division; // 64;
    int bar_height = screen_size.y / height_division; // 64;
    int width_tests = 1 + screen_size.x / bar_width;
    int height_tests = 1 + screen_size.y / bar_height;

...
void zox_tst_key_down_window_list(ecs *world, int32_t keycode) {
    ...
    zox_dbg_window_list = spawn_window_list(world, prefab_window, player, header_label, header_font_size, elements, visible_count, elements_count, list_font_size, close_event, 0, menu_type, 0, alignment, byte2_single(4)).x;
}
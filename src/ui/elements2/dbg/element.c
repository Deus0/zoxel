...
void zox_dbg_spawn_element(ecs *world, ClickEventData data) {
    ...
    entity element = spawn_uic(world, prefab_element_textured, canvas, float2_half, position, int2_single(size), int2_single(size), default_fill_color_icon, default_outline_color_icon);

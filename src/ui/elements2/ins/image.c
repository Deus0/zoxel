entity spawn_image(ecs* world, entity prefab, entity texture, entity canvas, entity parent, int2 position, int2 size, float2 panchor, byte layer, byte rdisabled) {
    zox_instance(prefab);
    zox_name("image");

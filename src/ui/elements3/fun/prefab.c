void add_element3D_transform(ecs *world, const entity e) {
...
void add_element3D_child(ecs *world, const entity e) {
...
void add_ui_components_world(ecs *world, const entity e, const float2 mesh_scale) {

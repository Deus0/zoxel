    ...
    entity character)
{
    ...
    if (!stats_length) {
        ...
        zox_logw(" - GenerateCharacter? %i",
            zox_getv(character, GenerateCharacter));
        return 0;
    }
    ...
    zox_add(e,  StatBars);
    // Now our bars
    int2 bar_position = (int2) {
        0,
        - bar_size.y / 2 + panel_height / 2
    };

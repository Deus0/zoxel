entity spawn_inspector(ecs *world, entity canvas, entity player, entity target) {
    ...
    int fsize = 14;
    int min_width = 560;
    entity e = spawn_window_list(world, prefab_inspector, player, header_label, header_font_size, fsize, (ClickEvent) { NULL }, 1, 0, min_width, zox_alignment_left, byte2_single(2), NULL, NULL, 0, visible_count).x;
    zox_name("inspector");
    zox_add_tag(e, InspectorUI);

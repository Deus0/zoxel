entity spawn_inspector(ecs *world, entity canvas, entity player, entity target) {
    ...
    entity4 e4 = spawn_window_list_at(world, prefab_inspector, canvas, position, size, zox_alignment_left, header_label, header_font_size, font_size, byte2_single(2), scrollbar_width, 1, (ClickEvent) { NULL });
    entity window = e4.x;
    entity header = e4.y;
    entity body = e4.z;

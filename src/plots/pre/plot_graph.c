...
entity spawn_plot_graph(ecs* world, entity parent, entity prefab, entity data_entity, int2 size, ushort lines_count, double start_value, color line_color) {
    ...
    zox_set(e, PlotDataLink, { data_entity });

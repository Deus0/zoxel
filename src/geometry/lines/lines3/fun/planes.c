void draw_planes(ecs *world, const plane *planes, const int plane_count) {
    ...
    for (int i = 0; i < plane_count; i++) {
        ...
        spawn_line3t(world, corners[0], corners[1], plane_color);
        spawn_line3t(world, corners[1], corners[2], plane_color);
        spawn_line3t(world, corners[2], corners[3], plane_color);
        spawn_line3t(world, corners[3], corners[0], plane_color);
        ...
        spawn_line3t(world, float3_zero, plane_point, plane_color);
    }
}

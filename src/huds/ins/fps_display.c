entity spawn_fps_display(ecs *world, entity canvas) {
    ...
    entity e = spawn_label(world, fps_display_prefab, parent, position, anchor, padding, "", font_size, zox_alignment_top_right, layer, button_fill, button_outline, button_font_fill, button_font_outline);

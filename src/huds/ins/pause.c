entity spawn_menu_paused(ecs *world, entity player) {
    ...
    entity e = spawn_window_list(world, prefab_window, player, menu_paused_header_label, header_font_size, list_font_size, (ClickEvent) { &on_closed_taskbar_window }, 1, 0, 0, alignment, byte2_single(4), NULL, elements, elements_count, elements_count).x;

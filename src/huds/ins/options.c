...
entity spawn_menu_options(ecs *world, entity player, entity canvas, int2 position, float2 anchor) {
    ...
    entity e = spawn_window_list(world, prefab_window, player, header_label, header_font_size, list_font_size, (ClickEvent) { &button_event_menu_main }, 1, 0, 0, zox_alignment_centre, byte2_single(4), NULL, elements, elements_count, visible_count).x;

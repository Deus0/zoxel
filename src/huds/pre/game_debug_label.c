...
entity spawn_game_debug_label(ecs *world, entity canvas) {
    ...
    entity zext = spawn_label_background(world, prefab_game_debug_label, parent, canvas, pixel_position, anchor, padding, "", font_size, alignment, layer, int2_half(parent_pixel_size), parent_pixel_size, button_fill, button_outline, debug_color_outline, debug_color_fill, 0);

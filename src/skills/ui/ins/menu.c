entity spawn_player_menu_skills(ecs* world, entity player) {
    ...
    entity e = spawn_datagrid_slots(world, prefab_window, prefab_frame, prefab_icon, prefab_label2, label_font_size, canvas, character, skillbook, cells_size, "Skills", default_fill_color_frame_skill, default_fill_color_frame_skill, position_anchor, position, frame_id);

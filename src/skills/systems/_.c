...
void define_systems_skills(ecs_world_t *world) {
    zox_define_system_state_event_1(RealmSkills,
        EcsOnLoad,
    ...
    zox_system_ctx_1(DamageAuraSystem,
        zoxp_mainthread,
        characters,
        [in] users.UserLink,
        [in] SkillActive,
    ...
    zox_system(DamageAuraRemoveSystem,
        EcsOnUpdate,
        [in] transforms3.Position3D,
        [out] stats.DotLinks,
        [out] hierarchys.Children
    );
    zox_system(DotsSystem,
        EcsOnUpdate,
        [in] users.UserLink,
